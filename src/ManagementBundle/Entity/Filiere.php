 ...
 * @ORM\Entity(repositoryClass="ManagementBundle\Repository\FiliereRepository")
 */
class Filiere
{
    /**
    ...
    /**
     * @var $referentiels
     * @ORM\OneToMany(targetEntity="ManagementBundle\Entity\Referentiel", mappedBy="filiere")
     */
